...
#
    def update_scores(self, dump_qvalues=True):
        ...
        for exp in history:
            ...
            # si ha dato una o dos iteraciones el juego por si lo castiga para que no se equivoque al inicilaizarle juego
            if t == 1 or t == 2:
                cur_reward = self.r[1]
            ...
            # Actualizar los valores de Q Markov Ecuacion, 
